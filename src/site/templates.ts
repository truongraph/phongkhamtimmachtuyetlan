...
export const TEMPLATES: SiteTemplate[] = [
  { id: 'classic', name: 'Cổ điển', desc: 'Thanh thông tin, hero kèm form, dải số liệu navy, dịch vụ dạng thẻ.', theme: { primary: '#1151E7', navy: '#234DBB', accent: '#d81e28', headingFont: 'display', radius: 14 }, header: 'utility', hero: 'form', card: 'shadow', button: 'rounded', image: 'arch', stats: 'band', why: 'cards', services: 'cards', specialties: 'pills', about: 'imageLeft', icons: 'rainbow', eyebrow: 'pill', rhythm: 'zebra' },
